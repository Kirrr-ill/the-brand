...
const listItems = document.querySelector(".bottom-content-list");

data.forEach(({ image, name, description, price }) => {
  const productEl = `
  <li class="bottom-content-list-item">
        <article class="bottom-content-item">
            <div class="bottom-content-list-img-link-wrp">
            <a href="#" class="bottom-content-list-img-link">
                <img
                class="bottom-content-list-img"
                src="${image}"
                alt="item1"
                />
            </a>
            </div>
            <div class="bottom-content-item-info">
            <h3 class="bottom-content-item-title">${name}</h3>
            <p class="bottom-content-item-txt">
                ${description}
            </p>
            <span class="bottom-content-item-price">$${price}</span>
            <button class="bottom-content-item-btn txt" type="button">
                <svg
                width="27"
                height="25"
                viewBox="0 0 27 25"
